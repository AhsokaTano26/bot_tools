...
TAG_MAPPING = {
    "BanG_Dream!": [
        ...
        "相羽爱奈", "工藤晴香", "中岛由贵", "樱川惠", "志崎桦音", "明坂聪美", "远藤祐里香",
        # Poppin'Party
        ...
        # 新增角色
        "汐见萤", "伊泽枣", "梅里千樱梨", "四宫宁月", "矢仓蓬咲",
        "须贺蕾叶", "马桥心玖", "和泉朋花", "琴平凪", "滨崎茉幌",
        "峰月律", "藤都子", "千石由乃", "仲町阿拉蕾", "宫永野乃花",
        # 新增中之人
        "咲川雏乃", "结川麻希", "伊驹祐里惠", "凉泉樱花", "远野光",
        "千春", "药师寺李有", "花宫初奈", "菱川花菜", "橘芽衣",
        "高尾奏音",
    ],
}
